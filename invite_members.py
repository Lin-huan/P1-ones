...
def invite_members(team_uuid, uuid, token, invite_count, license_types=(1, 2, 3)):
    ...
    for i in range(invite_count):
        mail = 'mu'+str(time1) + str(i) + '@ones.ai'
        # dictnew={"email":mail}
...
def invite(email, invite_count, invite_team='', password='a123456789', license_type=(1, 2, 3)):
    """
    :param email: 管理员账号
...
# 堡垒机
new_dev1 = {
    'referer_url': f'https://preview1-zhangsihao.dev.myones.net/project',
    'base_url': f'https://preview1-zhangsihao.dev.myones.net/project/api/project'
    # 'referer_url': f'http://120.79.214.210/project',
    # 'base_url': f'http://120.79.214.210/project/api/project'
}
...
if __name__ == '__main__':
    invite(email='marsdev@ones.ai', invite_count=2, invite_team='',
           password='Test1234', license_type=("project","wiki","testcase"))
